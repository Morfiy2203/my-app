...
import background1 from "./Components/Image/Салават_Юлаев.jpg";
import background2 from "./Components/Image/Монумент_Дружбы.jpg";
import background3 from "./Components/Image/7_девушек.jpg";
import background4 from "./Components/Image/Конгресс_холл.jpg";
import background5 from "./Components/Image/Парк_Якутова.jpg";
import background6 from "./Components/Image/Театр_Гафури.jpg";
import background7 from "./Components/Image/Национальный_музей.jpg";
import background8 from "./Components/Image/Сад_Аксакова.jpg";
import background9 from "./Components/Image/Парк_Ленина.jpg";
import background10 from "./Components/Image/Музей_Нестерова.jpg";
import background11 from "./Components/Image/Музей_полярников.jpg";
  ...
  var places = [
    {
      ...
      s: "1,5км",
      route:[
        [55.94068319612637, 54.72528242421217],
        [55.93815680175737, 54.720164593479666],
        ...
        <div className="panel">
          ...
          <select className="select" id="selector" onChange={fun1} >
            ...
            <div className="info">
              ...
              {places.map(({id, back})=>{
                if(id===index){
                  return(<div className="image" style={{backgroundImage: `url(${back})`}}></div>)
                }
              })}
            </div>
